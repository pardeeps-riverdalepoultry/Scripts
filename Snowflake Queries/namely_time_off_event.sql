...
select * from RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST;
DESC TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST;

-- change leave start data type
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST ADD COLUMN LEAVE_START_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST SET LEAVE_START_TEMP = LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST DROP COLUMN LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST RENAME COLUMN LEAVE_START_TEMP TO LEAVE_START;

COPY INTO RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST
    FROM @RPE_APOLLO.NAMELY.S3_NAMELY_TIME_OFF_EVENT/2024-06-20T13-41-48Z_cd38669e-d7c2-43c6-9467-261b669f1c79.parquet
    file_format =  (FORMAT_NAME = RPE_APOLLO.NAMELY.PARQUET_FILE_FORMAT)
    match_by_column_name = case_insensitive;

TRUNCATE TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST;


-- change leave start end type
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST ADD COLUMN LEAVE_END_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST SET LEAVE_END_TEMP = LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST DROP COLUMN LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_TEST RENAME COLUMN LEAVE_END_TEMP TO LEAVE_END;

--------------------------------------------------------------------
--------------------------------------------------------------------

desc table RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT;

-- change leave start 
ALTER TABLE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT ADD COLUMN LEAVE_START_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT SET LEAVE_START_TEMP = LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT DROP COLUMN LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT RENAME COLUMN LEAVE_START_TEMP TO LEAVE_START;


-- change leave start end type
ALTER TABLE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT ADD COLUMN LEAVE_END_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT SET LEAVE_END_TEMP = LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT DROP COLUMN LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.INCREMENTAL_UPDATE_TIME_OFF_EVENT_FULL_REPORT RENAME COLUMN LEAVE_END_TEMP TO LEAVE_END;


desc table RPE_APOLLO.NAMELY.incremental_update_time_off_event;

-- change leave start 
ALTER TABLE RPE_APOLLO.NAMELY.incremental_update_time_off_event ADD COLUMN LEAVE_START_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.incremental_update_time_off_event SET LEAVE_START_TEMP = LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.incremental_update_time_off_event DROP COLUMN LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.incremental_update_time_off_event RENAME COLUMN LEAVE_START_TEMP TO LEAVE_START;

-- change leave start end type
ALTER TABLE RPE_APOLLO.NAMELY.incremental_update_time_off_event ADD COLUMN LEAVE_END_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.incremental_update_time_off_event SET LEAVE_END_TEMP = LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.incremental_update_time_off_event DROP COLUMN LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.incremental_update_time_off_event RENAME COLUMN LEAVE_END_TEMP TO LEAVE_END;


desc table RPE_APOLLO.NAMELY.time_off_event;


-- change leave start data type
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT ADD COLUMN LEAVE_START_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT SET LEAVE_START_TEMP = LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT DROP COLUMN LEAVE_START;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT RENAME COLUMN LEAVE_START_TEMP TO LEAVE_START;


-- change leave start data type
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT ADD COLUMN LEAVE_END_TEMP DATE;
UPDATE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT SET LEAVE_END_TEMP = LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT DROP COLUMN LEAVE_END;
ALTER TABLE RPE_APOLLO.NAMELY.TIME_OFF_EVENT_FULL_REPORT RENAME COLUMN LEAVE_END_TEMP TO LEAVE_END;